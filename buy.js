...
document.body.appendChild( renderer.domElement );
 ...
 var light = new THREE.DirectionalLight( new THREE.Color("gray"), .5);
...
//flag light
var pointflagLight = new THREE.PointLight(new THREE.Color('gold'), 1, 5);
...
for (var i = 0; i < 1000; i++) {
    var stars = new THREE.Mesh(new THREE.TetrahedronGeometry(2, 0), new THREE.MeshPhongMaterial({ color: 0xffffff, shading: THREE.FlatShading}));
...
textureLoader.crossOrigin = '';
 ...
 var texture = textureLoader.load('https://raw.githubusercontent.com/baronwatts/images/master/dogeflag4.png');
...
loader.load("https://raw.githubusercontent.com/baronwatts/models/master/moon.js", function(geometry, materials) {
...
var loader = new THREE.LegacyJSONLoader();
loader.load("https://raw.githubusercontent.com/baronwatts/models/master/rocketship.js", function(geometry, materials) {
  var model = new THREE.Mesh(geometry, materials);
  model.scale.set(1,1,1);
...
var loader = new THREE.LegacyJSONLoader();
loader.load("https://raw.githubusercontent.com/baronwatts/models/master/satellite.js", function(geometry, materials) {
  var model = new THREE.Mesh(geometry, materials);
...
var height = .015;
var geometry = new THREE.CylinderGeometry( .05, .05, height, 32 );
